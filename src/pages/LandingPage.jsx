        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-gradient-to-r from-blue-500 to-green-400 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:from-blue-400 hover:to-green-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
              >
                Get started
              </a>
              <a href="#" className="text-sm/6 font-semibold text-white">
